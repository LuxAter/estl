...
namespace variable {
  class Variable {
   public:
    ...
    Variable(const unsigned long long int& val)
    ...
    Variable(const std::vector<unsigned short int>& val)
        : is_valid_(true), value_(val) {}
    Variable(const std::vector<signed int>& val)
        : is_valid_(true), value_(val) {}
    ...
    unsigned int Type() const {
      ...
      } else if (std::holds_alternative<std::vector<signed short int>>(
                     value_) == true) {
      ...
      } else if (std::holds_alternative<std::vector<unsigned long int>>(
                     value_) == true) {
    ...
    void PushBack(estl::variable::Variable val) {
      switch (val.Type()) {
        case BOOL: {
        ...
        case SIGNED_CHAR: {
          PushBack(val.GetSignedChar());
          break;
        }
        case UNSIGNED_CHAR: {
          PushBack(val.GetUnsignedChar());
          break;
        }
        case SIGNED_SHORT_INT: {
          PushBack(val.GetSignedShortInt());
          break;
        }
        case UNSIGNED_SHORT_INT: {
          PushBack(val.GetUnsignedShortInt());
          break;
        }
        case SIGNED_INT: {
          PushBack(val.GetSignedInt());
          break;
        }
        case UNSIGNED_INT: {
          PushBack(val.GetUnsignedInt());
          break;
        }
        case SIGNED_LONG_INT: {
          PushBack(val.GetSignedLongInt());
          break;
        }
        case UNSIGNED_LONG_INT: {
          PushBack(val.GetUnsignedLongInt());
          break;
        }
        case SIGNED_LONG_LONG_INT: {
          PushBack(val.GetSignedLongLongInt());
          break;
        }
        case UNSIGNED_LONG_LONG_INT: {
          PushBack(val.GetUnsignedLongLongInt());
          break;
        }
        case FLOAT: {
          PushBack(val.GetFloat());
          break;
        }
        case DOUBLE: {
    ...
    void PushBack(bool val) {
      if (is_valid_ == true &&
        ...
        std::vector<bool> vec = std::get<std::vector<bool>>(value_);
        vec.push_back(val);
        value_ = vec;
    ...
    void PushBack(char val) {
      if (is_valid_ == true &&
        ...
        std::vector<char> vec = std::get<std::vector<char>>(value_);
        vec.push_back(val);
        value_ = vec;
      } else if (is_valid_ == false) {
        is_valid_ = true;
    ...
    void PushBack(unsigned char val) {
      if (is_valid_ == true &&
        ...
        std::vector<unsigned char> vec =
            std::get<std::vector<unsigned char>>(value_);
        vec.push_back(val);
        value_ = vec;
      } else if (is_valid_ == false) {
        is_valid_ = true;
    ...
    void PushBack(signed short int val) {
      if (is_valid_ == true &&
          std::holds_alternative<std::vector<signed short int>>(value_) ==
              true) {
        std::vector<signed short int> vec =
            std::get<std::vector<signed short int>>(value_);
        vec.push_back(val);
        value_ = vec;
      } else if (is_valid_ == false) {
        is_valid_ = true;
    ...
    void PushBack(signed int val) {
      if (is_valid_ == true &&
          std::holds_alternative<std::vector<signed int>>(value_) == true) {
        std::vector<signed int> vec = std::get<std::vector<signed int>>(value_);
        vec.push_back(val);
        value_ = vec;
      } else if (is_valid_ == false) {
        is_valid_ = true;
    ...
    void PushBack(unsigned int val) {
      if (is_valid_ == true &&
        ...
        std::vector<unsigned int> vec =
            std::get<std::vector<unsigned int>>(value_);
        vec.push_back(val);
        value_ = vec;
      } else if (is_valid_ == false) {
        is_valid_ = true;
    ...
    void PushBack(signed long int val) {
      if (is_valid_ == true &&
          std::holds_alternative<std::vector<signed long int>>(value_) ==
              true) {
        std::vector<signed long int> vec =
            std::get<std::vector<signed long int>>(value_);
        vec.push_back(val);
        value_ = vec;
      } else if (is_valid_ == false) {
        is_valid_ = true;
    ...
    void PushBack(float val) {
      if (is_valid_ == true &&
        ...
        std::vector<float> vec = std::get<std::vector<float>>(value_);
        vec.push_back(val);
        value_ = vec;
      } else if (is_valid_ == false) {
        is_valid_ = true;
    ...
    void PushBack(double val) {
      if (is_valid_ == true &&
        ...
        std::vector<double> vec = std::get<std::vector<double>>(value_);
        vec.push_back(val);
        value_ = vec;
      } else if (is_valid_ == false) {
        is_valid_ = true;
    ...
    void PushBack(long double val) {
      if (is_valid_ == true &&
          std::holds_alternative<std::vector<long double>>(value_) == true) {
        std::vector<long double> vec =
            std::get<std::vector<long double>>(value_);
        vec.push_back(val);
        value_ = vec;
      } else if (is_valid_ == false) {
        is_valid_ = true;
    ...
    void PushBack(const char* val) {
      if (is_valid_ == true &&
        ...
        std::vector<const char*> vec =
            std::get<std::vector<const char*>>(value_);
        vec.push_back(val);
        value_ = vec;
      } else if (is_valid_ == false) {
        is_valid_ = true;
    ...
    inline std::vector<signed long long int> GetSignedLongLongIntVector()
        const {
      if (is_valid_ == true &&
          std::holds_alternative<std::vector<signed long long int>>(value_) ==
              true) {
  ...
  inline std::ostream& operator<<(std::ostream& out, const Variable& lhs) {
    ...
    if (std::holds_alternative<bool>(val)) {
      ...
      for (std::vector<bool>::iterator it = vec.begin(); it != vec.end();
           ++it) {
      ...
      std::vector<unsigned char> vec =
          std::get<std::vector<unsigned char>>(val);
      for (std::vector<unsigned char>::iterator it = vec.begin();
           it != vec.end(); ++it) {
        out << (*it);
        if (it != --vec.end()) {
          out << ", ";
      ...
      for (std::vector<unsigned int>::iterator it = vec.begin();
           it != vec.end(); ++it) {
        out << (*it);
        if (it != --vec.end()) {
          out << ", ";
      ...
      for (std::vector<float>::iterator it = vec.begin(); it != vec.end();
           ++it) {
        out << (*it);
        if (it != --vec.end()) {
          out << ", ";
