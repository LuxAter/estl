   ...
   public:
    ...
    class const_sibling_iterator : public iterator_base {
     public:
      ...
      const _Tp& operator*() const { return node_->node; }
      const _Tp* operator->() const { return &(node_->node); }
    ...
    reference child_front() { return *child_begin(); }
    const_reference child_front() const { return *cchild_begin(); }

    reference leaf_front() { return *leaf_begin(); }
    const_reference leaf_front() const { return *cleaf_begin(); }

    reference back() { return *this->last_; }
    const_reference back() const { return *this->last_; }

    reference child_back() { return *(--child_end()); }
    const_reference child_back() const { return *(--cchild_end()); }

    reference leaf_back() { return *(--leaf_end()); }
    const_reference leaf_back() const { return *(--cleaf_end()); }
